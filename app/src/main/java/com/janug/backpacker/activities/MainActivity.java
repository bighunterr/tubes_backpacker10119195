package com.janug.backpacker.activities;
...
import com.janug.backpacker.R;
import com.janug.backpacker.Tools;
import com.janug.backpacker.adapter.MainAdapter;
import com.janug.backpacker.layout.LayoutMarginDecoration;
import com.janug.backpacker.model.MainModel;
import com.janug.backpacker.presenter.MainSlidePresenter;
...
public class MainActivity extends AppCompatActivity implements MainAdapter.onSelectData, NavigationView.OnNavigationItemSelectedListener {
    ...
    private void setMenu() {
        mdlMainMenu = new MainModel("Gunung", R.drawable.ic_mountain);
    ...
    public boolean onNavigationItemSelected(@NonNull final MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_about:
                ...
                builder.setMessage("Aplikasi untuk menemukan daftar gunung di Indonesia");
