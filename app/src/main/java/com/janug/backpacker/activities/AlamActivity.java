...
import com.janug.backpacker.adapter.AlamAdapter;
import com.janug.backpacker.layout.LayoutMarginDecoration;
import com.janug.backpacker.model.ModelAlam;
...
public class AlamActivity extends AppCompatActivity implements AlamAdapter.onSelectData {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tbWisata.setTitle("Daftar Gunung di Indonesia");
        ...
        reference = FirebaseDatabase.getInstance("https://backpacker-2c1a4-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("Alam");
